...
<div id="page-content" class="clearfix">
    ...
    <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs ml15 mr15" role="tablist">
        ...
        <?php if ($show_contract_info) { ?>
            <li><a  role="presentation" href="<?php echo_uri("clients/contracts/" . $client_info->id); ?>" data-bs-target="#client-contracts"> <?php echo app_lang('contracts'); ?></a></li>
        <?php } ?>
        <?php if ($show_proposal_info) { ?>
            <li><a  role="presentation" href="<?php echo_uri("clients/proposals/" . $client_info->id); ?>" data-bs-target="#client-proposals"> <?php echo app_lang('proposals'); ?></a></li>
        <?php } ?>
        ...
        <?php
        $hook_tabs = app_hooks()->apply_filters('app_filter_client_details_ajax_tab', $client_info->id);
